...
function NotiflixReportAlert(title, message, buttonText, width, svgSize, type) {
    switch (type) {
        case "success":
...
function NotiflixReportAlertCallback(title, message, buttonText, width, svgSize, type) {
